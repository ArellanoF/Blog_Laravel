...
@section('styles')
<link rel="stylesheet" href="{{asset('css/manage_post/post/css/article_show.css')}}" class="css">
<link rel="stylesheet" href="{{asset('css/manage_post/comments/css/comments.css')}}" class="css">
@endsection('')
